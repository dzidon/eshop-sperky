...
class PaymentMethod
{
     ...
     *
     * @Assert\Length(max=255, maxMessage="Maximální počet znaků v názvu platební metody: {{ limit }}")
     * @Assert\NotBlank
     */
    private $name;

    /**
     * @Vich\UploadableField(mapping="payment_method_images", fileNameProperty="imagePath")
     *
     * @Assert\File(
